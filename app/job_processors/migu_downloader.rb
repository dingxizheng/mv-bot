...
class MiguDownloader < BaseProcessor
  class << self
    def start
      start_processing do
        loop do
    ...
    def find_job_to_process
      ...
      if job.present?
        ...
        LOG.info "No music job found for MiguDownloader, retry in 10 seconds."
        sleep(10)
      end
    end
    ...
    def process_job(music_job)
      ...
      if !music_job.ass_subtitles_generated
        ...
        MiguMusic.lyrics_to_ass_file(song.lyrics_list, path: song.ass_file_path)
